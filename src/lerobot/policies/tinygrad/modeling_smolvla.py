...
class SmolVLAPolicyTinyOnnx(SmolVLAPolicy):
...
class SmolVLAFlowOnnx:
    def __init__(self, config: SmolVLAConfig, repo=None):
        ...
        self.vlme = SmolVLMWithExpertModelTinyOnnx(
            hf_repo=repo)
