...
def eval_main():
    ...
    import sys
    sys.argv += ["--policy.path=lerobot/smolvla_base"]
    sys.argv += ["--policy.revision=3326b100334ffc0a0bd1ec27e3afb1cfa2a6000c"]
    ...
    cfg = EvalPipelineConfig(env=AlohaEnv(), policy=config)

    # cfg.env = "aloha"

    cfg.policy.adapt_to_pi_aloha = True
